...
class Solution:
    ...
    # In worst case, both pointers need to move N steps
    # duplicate to replace elements by "fast_p -> slow_p"
    ...
    def removeElement_2(self, nums: List[int], val: int) -> int:
        ...
        while left_p <= right_p:
            if nums[left_p] == val:
                ...
                left_p += 1
        return left_p  # , nums[:left_p]
# time complexity: O(N)
# space complexity: O(1)

# mySolution = Solution()
# x = [0, 1, 2, 2, 3, 0, 4, 2]
# print(mySolution.removeElement_2(x, 2))
